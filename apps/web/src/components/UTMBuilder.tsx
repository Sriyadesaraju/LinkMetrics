...
export function UTMBuilder({ baseUrl, onChange }: Props) {
  ...
  const fields: { key: keyof UTMParams; label: string; placeholder: string }[] = [
    { key: 'source', label: 'Source', placeholder: 'google, twitter, newsletter' },
    { key: 'medium', label: 'Medium', placeholder: 'cpc, email, social' },
    { key: 'campaign', label: 'Campaign', placeholder: 'summer-sale, launch-2024' },
    { key: 'content', label: 'Content', placeholder: 'banner-top, link-footer' },
    { key: 'term', label: 'Term', placeholder: 'running+shoes (paid search)' },
  ]
